...
import 'package:flutter_milk_shop/models/Variant.dart';
        ...
        : RefreshIndicator(
          ...
          itemBuilder: (context, index){
            ...
            return Card(
              ...
              child: ListTile(
                leading: product.image_path.isNotEmpty ? Image.network(product.image_path, width: 50, height: 50, fit: BoxFit.cover,)
